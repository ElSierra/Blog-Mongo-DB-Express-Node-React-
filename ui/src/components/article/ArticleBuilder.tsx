            ...
            <div className="row mb-40 list-style-2">
                <div className="col-md-4">
                    <div className="post-thumb position-relative border-radius-5">
                        <div className="img-hover-slide border-radius-5 position-relative"  style={{ backgroundImage: `url(${props.postImg})` }}>
                            <a className="img-link" href= '' onClick={() => {
                  props.setPage({
                  title: props.title,
                  ...
                  title: props.title,
                   ...
                   authorImg: props.authorImg,
                        ...
                        <div className="entry-meta meta-1 float-left font-x-small text-uppercase">
                            ...
                            <span className="time-reading has-dot">{props.authorName}</span>
